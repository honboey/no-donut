    ...
    <div className="flex justify-between flex-col lg:flex-row lg:flex-row-reverse mb-12 lg:mb-20">
      <div className="lg:w-2/3">
        ...
        <p className="sm:text-lg lg:text-2xl leading-snug">
          This website is continually being updated and refined. If you have a
          resource you would like to share please email us at{" "}
          <a
            className="underline"
            href="mailto:badcopnodonut@dialogicstudios.com.au"
          >
            badcopnodonut@dialogicstudios.com.au
          </a>
          .
        </p>
      </div>
